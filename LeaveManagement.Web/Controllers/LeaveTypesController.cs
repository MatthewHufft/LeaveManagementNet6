...
namespace LeaveManagement.Web.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,DefaultDays,Id,DataCreated,DataModified")] LeaveTypeVM leaveTypeVM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,DefaultDays,Id,DataCreated,DataModified")] LeaveType leaveType)
        {
            if (id != leaveType.Id)
            {
                return NotFound();
